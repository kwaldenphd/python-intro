...
Q4: Write a program that creates `first_name` and `last_name` variables, and then uses concatenation to create (and then print) a `full_name` variable. Answer to this question includes program + comments that document process and explain your code.
